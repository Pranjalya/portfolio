    ...
    >
      ...
      >
        <svg
          ...
          class="w-150px smp:w-150px sml:w-250px md:w-200px lg:w-250px xl:w-350px xxl:w-400px h-150px smp:h-150px sml:h-200px md:h-200px lg:h-250px xl:h-350px xxl:h-400px"
        >
          <linearGradient
            id="SVGID_1_"
          ...
          >
            ...
            <stop offset=".041" stop-color="#00a5bf" />
            <stop offset=".099" stop-color="#0ca0a5" />
            <stop offset=".159" stop-color="#169c91" />
            <stop offset=".221" stop-color="#1a9983" />
            <stop offset=".286" stop-color="#1d977b" />
            <stop offset=".361" stop-color="#1d9678" />
        ...
        <span
          id="skill-1"
          class="absolute label pin-gestion text-right min-w-0 max-w-60px sml:max-w-80px smp:max-w-80px md:max-w-80px lg:max-w-100px xl:max-w-100px xxl:max-w-100px"
          @mouseover="setSkill(1)"
          @mouseleave="setSkill(null)"
        ...
        <span
          id="skill-2"
          class="absolute label pin-conduite text-right max-w-60px sml:max-w-80px smp:max-w-80px md:max-w-80px lg:max-w-100px xl:max-w-100px xxl:max-w-100px"
          @mouseover="setSkill(2)"
          @mouseleave="setSkill(null)"
          >Conduite du changement</span
        >
        <span
          id="skill-3"
          class="absolute label pin-consulting text-right max-w-150px sml:max-w-150px smp:max-w-150px md:max-w-150px lg:max-w-150px xl:max-w-150px xxl:max-w-150px"
          @mouseover="setSkill(3)"
          @mouseleave="setSkill(null)"
          >Consulting</span
        >
        <span
          id="skill-4"
          class="absolute label pin-strategie text-left max-w-150px sml:max-w-150px smp:max-w-150px md:max-w-150px lg:max-w-150px xl:max-w-150px xxl:max-w-150px"
          @mouseover="setSkill(4)"
          @mouseleave="setSkill(null)"
